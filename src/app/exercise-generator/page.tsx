...
${results.suggestions.map((s: string) => `- ${s}`).join('\n')}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="mb-2 text-3xl font-bold">Trumpet Exercise Generator</h1>
        <p className="text-gray-600">
          Generate customized trumpet exercises using Mistral 7B AI
        </p>
        {needsToken && (
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            <div className="mb-4 grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="tonguing">Tonguing</option>
              ...
              <div>
                ...
                >
                  ...
                  {formData.focusType === "tonguing" && (
                    <>
                      <option value="single">Single Tonguing</option>
                      <option value="double">Double Tonguing</option>
                      <option value="triple">Triple Tonguing</option>
                      <option value="slurred">Slurred Passages</option>
                    </>
                  )}
                  {formData.focusType === "flexibility" && (
                    <>
                      <option value="lipslurs">Lip Slurs</option>
                      <option value="register">Register Jumps</option>
                      <option value="bends">Note Bends</option>
                      <option value="legato">Legato Playing</option>
                    </>
                  )}
                </select>
              </div>
            ...
            <div className="mt-6">
              ...
              >
                {generationStatus === "generating"
                  ? "Generating..."
                  : "Generate Trumpet Exercise"}
              </button>
            </div>
          </form>

          <div className="mt-6">
            <TrumpetSoundPlayer selectedKey={formData.key} />
          </div>

          <div className="mt-4">
            <button
              onClick={toggleChatbot}
              className="w-full rounded-md border border-primary bg-white py-2 text-primary hover:bg-primary/10"
            >
              {showChatbot ? "Hide Practice Assistant" : "Show Practice Assistant"}
            </button>
          </div>
        </div>
        ...
        <div className="lg:col-span-8">
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            ...
            {generationStatus === "idle" && (
              <div className="flex h-64 flex-col items-center justify-center text-gray-500">
                <p className="mb-2 text-center">
                  Fill out the form and click "Generate Trumpet Exercise" to see a preview
                </p>
            ...
            {generationStatus === "generating" && (
              <div className="flex h-64 flex-col items-center justify-center">
                ...
                <p className="mt-4 text-gray-600">Generating your trumpet exercise with Mistral 7B...</p>
              </div>
            )}
            ...
            {generationStatus === "success" && generatedExercise && (
              <div className="flex flex-col">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    onClick={() => {
                      try {
                        ...
                        downloadMIDI(midiData, `trumpet-exercise-${generatedExercise.exerciseId}.mid`);
                      } catch (error) {
                  ...
                  <button
                    onClick={() => downloadXML(generateExerciseMetadataXML(generatedExercise), `trumpet-exercise-${generatedExercise.exerciseId}.xml`)}
            ...
            {generationStatus === "error" && (
              <div className="flex h-64 flex-col items-center justify-center text-red-600">
                ...
                <p className="mt-4 text-center">
                  Something went wrong while generating your trumpet exercise. Please try again.
                </p>
                {needsToken && (
          ...
          {showChatbot && (
            <div className="mt-8">
              <TrumpetChatbot initialMessage="I'm your trumpet practice assistant. I can help you with your trumpet technique, exercises, and practice routine. What would you like help with today?" />
            </div>
          )}
        </div>
      </div>
